...
def submit_action():
    ...
    if message_text=="":
        message_text+="You have chosen nothing\n"
...
tea_cb = Checkbutton(window, text ="Tea", variable=t_var, onvalue=True, offvalue=False, width=20, height=2)
tea_cb.pack()

water_cb = Checkbutton(window, text ="Water", variable=w_var, onvalue=True, offvalue=False, width=20, height=2)
water_cb.pack()
